...
iScroll.prototype = {
	...
	setPosition: function (x, y) { 
		...
		// ensures we only scroll the direction we want to overflow in
    this.element.style.webkitTransform = 'translate3d(' + (this.scrollX ? this._xPos : 0) + 'px, ' + (this.scrollY ? this._yPos : 0) + 'px, 0)';
